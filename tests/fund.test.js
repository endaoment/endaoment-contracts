...
describe("Token contract", function () {
  ...
  beforeEach(async function () {
    ...
    token = await Token.new("Zora", "ZORA", 0, accounts[0], 20, 50);
  });
  ...
  it("does not have a supply cap when 0", async function () {
    token = await Token.new("Zora", "ZORA", 0, accounts[0], 20, 0);
  ...
  describe("permit()", function () {
    ...
    it("initializes the EIP712 domain separator", async function () {
      ...
      assert.equal(
        "0x7bcbc69f252066abef2415638baf6bac19f68bbc6c05970cf84571b776c456bd",
        val
      );
    });
    ...
    it("allows permit calls with valid signature to override the allowance", async function () {
      ...
      [v, r, s] = generatePermitSignature(accounts[1], accounts[2], 0, 1, 0);
